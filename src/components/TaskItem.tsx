...
export const TaskItem = forwardRef(function TaskItem({ task, toggleTaskDone, removeTask, addSubtask, ...rest }: Props, ref: Ref<HTMLLIElement>) {
  return (
    <li ref={ref} className='bg-gray-500 rounded-md p-4 flex justify-between items-center' {...rest}>
      ...
      <div className='flex gap-2'>
        <Subtasks task={task} addSubtask={addSubtask} />
